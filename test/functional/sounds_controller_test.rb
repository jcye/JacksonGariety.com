...
class SoundsControllerTest < ActionController::TestCase
  ...
  test "should create sound" do
    assert_difference('Sound.count') do
      post :create, sound: { album: @sound.album, artist: @sound.artist, date: @sound.date, description: @sound.description, slug: @sound.slug, sound: @sound.sound, thumb: @sound.thumb, title: @sound.title }
    end
  ...
  test "should update sound" do
    put :update, id: @sound, sound: { album: @sound.album, artist: @sound.artist, date: @sound.date, description: @sound.description, slug: @sound.slug, sound: @sound.sound, thumb: @sound.thumb, title: @sound.title }
    assert_redirected_to sound_path(assigns(:sound))
  end
